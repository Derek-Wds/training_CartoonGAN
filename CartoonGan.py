    ...
    def train(self):
        ...
        for epoch in range(1,self.epochs+1):
            ...
            for idx, (photo, cartoon, smooth_cartoon, index) in enumerate(batch_generator):
                ...
                if epoch % 50 == 0:
                    self.generator.save_weights('CartoonGan_generator_epoch_{}.h5'.format(epoch))
                    self.discriminator.save_weights('CartoonGan_discriminator_epoch_{}.h5'.format(epoch))
                    self.train_generator.save_weights('CartoonGan_train_generator_epoch_{}.h5'.format(epoch))
